function [x,y] = evolve(x,y,alpha,beta,gamma,kappa,fx,fy,ITER)

%Alpha       Elasticity factor
%Beta        Bending factor
%Gamma       Internal Energy term
%Kappa       External energy term

% Find a system of equations using the parameters given from GUI
% and differential equations provided in the paper
% Iterativelly solving will give the steady state position of the 
% snake contour.
